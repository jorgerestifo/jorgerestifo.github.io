...
Spritesmith.prototype = {
  ...
  processImages: function (images, options) {
    ...
    let evenDimensions = options.evenDimensions || false; // NOTE: need this to avoid .5 pixel w ComboSprite
    ...
    images.forEach(function (img) {
      ...
      let totalW = width + padding;
      let totalH = height + padding;
      if(evenDimensions){
        // for 1x, 1.5x, 2x combo spritesheet (divisible by 6)
        totalW += 6 - totalW % 6;
        totalH += 6 - totalH % 6;
      }
