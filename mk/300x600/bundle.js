(function () {
  ...
  var Banner = {
    init: function init() {
      ...
      var vc = new VideoControls('300x600_video.mp4', 300, 600, vOptions);
      ...
      function frame0() {
        tl.from('#prism', 1, {
          ...
          cycle: {
            rotation: [-215, -215, -305, -215, -125]
          },
          ease: Cubic.easeInOut
        }, 0.03, '-=1.25').to("#cta", 0.2, {
          autoAlpha: 0
        }, "-=1").set("#logo-gpo-white", {
          autoAlpha: 0
        }, "-=1").set("#logo-gpo-grey", {
          autoAlpha: 1
        }, "-=1").from(['#headline', '#subline'], 1, {
          autoAlpha: 0
        }).set("#cta", {
          className: "+=cta-ef"
        }, "-=1").to("#cta", 0.5, {
