...
var Banner = {
  ...
  function triggerAnim()
  {
    ...
    interval = setInterval(sprite_anim, 140);
    //console.log("aa");
  }
    ...
    function frame0() {
      ...
      .staggerFrom(["#headline","#subline","#tilde","#cta"],.5,{autoAlpha:0},1.2)
    }
   ...
   function onAdHover(e) {
      ...
      TweenMax.set("#cta_txt",{fill:"#fff"})
    }

    function onAdOut(e) {
      TweenMax.set("#cta_txt",{fill:"#111"})
      TweenMax.set("#cta",{backgroundColor:"none"})
    }
