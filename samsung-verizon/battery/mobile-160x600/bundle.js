    ...
    init: function init() {
      ...
      function frame0() {
        ...
        function phones() {
          ...
          tl.staggerFrom(['#phone-01-image', '#headline-01'], 1, {
          ...
          }, '-=0.5').add("scale").set('#phone-01-body', {
            autoAlpha: 1
          }, "scale").to('#phone-01', 1, {
            scale: 0.55,
            x: 12,
            ...
            autoAlpha: 0
          }, "scale") // .from('#phone-01-body', 1, { autoAlpha: 0 }, '-=0.5')
          // .to('#phone-01', 1, { scale: 0.54, x: 17, y: 149, ease: Cubic.easeInOut, force3D: false }, '-=1')
          // .to(['#glow', '#spin'], 1, { autoAlpha: 0 })
          .set('#phone-02', {
            autoAlpha: 1
          }, '-=1').from('#phone-02', 1, {
            x: '-=55',
          ...
          .to(['#headline-02, #phone-02, #phone-01'], 0.5, {
            autoAlpha: 0
          }, '+=1.5');
          return tl;
        }
