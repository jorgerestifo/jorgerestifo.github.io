    ...
    init: function init() {
      ...
      function frame0() {
        ...
        function phones() {
          ...
          }, '-=0.5') // .to('#phone-01-wrap',.5,{className:"+=overflow"},"-=1")
          .add("scale").set('#phone-01-body', {
            autoAlpha: 1
          }, "scale").to('#phone-01', 1, {
            scale: 0.6,
            x: 252,
            y: 144,
            force3D: false
          }, "scale").to('#phone-01-body', 1, {
            css: {
              left: 461,
              top: 74,
              scale: 1.45
            }
          }, "scale").to('#phone-01-wrap', 1, {
            css: {
              left: 432,
              top: 8,
              width: 211,
            ...
            autoAlpha: 0
          }, '-=0.5').staggerTo(['#headline-02, #phone-02, #phone-01'], 0.5, {
            autoAlpha: 0
          }, 0.15, '+=1.5');
          return tl;
        }
        ...
        function endframe() {
          var tl = new TimelineLite();
          tl.staggerFrom(['#verizon-black, #phones-ef', '#headline-ef', '#subline', '#cta', '#legal'], 1, {
            autoAlpha: 0
          }, 0.5);
          return tl;
        }
