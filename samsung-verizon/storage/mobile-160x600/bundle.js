  ...
  var Banner = {
    init: function init() {
      ...
      function addRollover() {
        ...
        }); // dom.legal.addEventListener('mouseenter', () => {
        //   TweenLite.to('#legal-box', 0.5, { autoAlpha: 1 });
        // });
        // dom.legal.addEventListener('mouseleave', () => {
        //   TweenLite.to('#legal-box', 0.5, { autoAlpha: 0 });
        // });
      }
