  ...
  var Banner = {
    ...
    init: function init() {
      ...
      function frame0() {
        ...
        var tl = new TimelineMax({ repeat: 8, yoyo: true, repeatDelay: 1, onComplete: addRollover });

        tl.staggerFrom('#neon', .05, { autoAlpha: .5, repeat: 4, yoyo: true });
      }
      ////////////////////////////////////////////////////// EVENT HANDLERS //////////////////////////////////////////////////////
      ...
      function addRollover() {
        ...
        dom.ad_content.addEventListener('mouseleave', function () {
          TweenLite.set('#cta-text-hover', { autoAlpha: 0 });
        });
      }
