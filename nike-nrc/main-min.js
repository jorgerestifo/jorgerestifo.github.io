...
var Banner = {
  ...
  init: function() {
    ...
    function frame0() {
        ...
        .from('#pie',2,{rotation:40,ease:Sine.easeOut},"-=.5")
        .staggerFrom(['#dot_1','#dot_2','#dot_3','#dot_4','#dot_5','#dot_6','#dot_7','#dot_8','#dot_9','#dot_10','#dot_11','#dot_12','#dot_13','#dot_14'],.2,{autoAlpha:0},.1,"-=2")
        .from('#rayos',.8,{scale:10,ease:Elastic.easeOut.config(.2)})
        .to(['#rayos path','#rayos polygon'],.1,{fill:"black",repeat:3,yoyo:true},"-=.5")
        .from('#txt',.5,{scale:0,ease:Sine.easeOut},"-=.5")
        .to('#pie',.3,{scale:.7,x:-90,y:+16, ease:Sine.easeIn},"-=1")
        .to(['#scaler'],4,{scale:1.1,force3D:false},"-=.5")
        .set(['#pie','#rayos','#txt'],{autoAlpha:0},"-=1")
        .staggerFrom(['#nrc_logo','#cta'],.1,{autoAlpha:0},.2,"-=1")
      }
   ...
   function onAdHover(e) {
      TweenMax.set('#nrc_path', {fill:"#d0ff00"});
      TweenMax.set('#ad_content', {backgroundColor:"black"});
      TweenMax.set('#cta', {backgroundColor:"#d0ff00"});
      TweenMax.set('#cta_path', {fill:"black"});
     
    }

    function onAdOut(e) {
      TweenMax.set('#nrc_path', {fill:"black"});
      TweenMax.set('#ad_content', {backgroundColor:"#d0ff00"});
      TweenMax.set('#cta', {backgroundColor:"black"});
      TweenMax.set('#cta_path', {fill:"#d0ff00"});
    }
